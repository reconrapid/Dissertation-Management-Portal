...
if (isset($_POST['edit_btn'])) {
  ...
  //Get database info fron config.php
    ...
    //Select the page we want to edit
    $sql3 = "SELECT * FROM pages WHERE page_id = '$page_id'";
    $result3 = $conn->query($sql3);
    $row3 = $result3->fetch_assoc();

    //Edit page in topicinfo
    ...
    $sql = "UPDATE pages SET page_topic='$row[topic_id]', published='$published' WHERE page_id = '$page_id'";
