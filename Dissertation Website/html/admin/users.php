...
<head>
  ...
  <script>
    function showResult(str) {
      ...
      xmlhttp.open("GET", "livesearch/livesearch_users.php?q=" + str, true);
      xmlhttp.send();
    }
  </script>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-2">
          ...
          <a href="users.php" class="list-group-item list-group-item-action active"><i class="fas fa-users"></i> Users</a>
